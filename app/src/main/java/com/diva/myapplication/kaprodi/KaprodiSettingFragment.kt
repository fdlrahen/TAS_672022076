package com.diva.fragmentsiasat.kaprodi // Mengoreksi nama paket
...
import com.diva.myapplication.databinding.FragmentKaprodiSettingBinding
import com.google.firebase.auth.FirebaseAuth // Asumsikan Anda menggunakan Firebase Auth

class KaprodiSettingFragment : Fragment() {

    private var _binding: FragmentKaprodiSettingBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentKaprodiSettingBinding.inflate(inflater, container, false)
        return binding.root
    }
