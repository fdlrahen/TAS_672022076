...
import com.diva.myapplication.databinding.FragmentDosenSettingBinding
import com.google.firebase.auth.FirebaseAuth

class DosenSettingFragment : Fragment() {

    private var _binding: FragmentDosenSettingBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDosenSettingBinding.inflate(inflater, container, false)
        return binding.root
    }
